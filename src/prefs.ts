    ...
    fillPreferencesWindow(window: Adw.PreferencesWindow): Promise<void> {
        ...
        const keybindings: [
            ...
            [
                ...
                _('Swap window right'),
                _('Swap the focused window with the window to its right'),
                false,
                false,
            ],
            [
                ...
                _('Swap window left'),
                _('Swap the focused window with the window to its left'),
                false,
                false,
            ],
            [
                ...
                _('Swap window up'),
                _('Swap the focused window with the window above'),
                false,
                false,
            ],
            [
                ...
                _('Swap window down'),
                _('Swap the focused window with the window below'),
                false,
                false,
            ],
            [
